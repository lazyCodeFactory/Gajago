	...
	for (var state in aus) {
		...
		(function (st, state) {
			...
			st[0].onclick = function (e) {
				...
				if(current =='seoul'){
					vCityName="서울";
				}else if(current =='gygg'){
					vCityName="경기";
				}else if(current =='incheon'){
					vCityName="인천";
				}else if(current =='chungbuk'){
					vCityName="충북";
				}else if(current =='daegu'){
					vCityName="대구";
				}else if(current =='daejeon'){
					vCityName="대전";
				}else if(current =='chungnam'){
					vCityName="충남";
				}else if(current =='jeonbuk'){
					vCityName="전북";
				}else if(current =='gyeongnam'){
					vCityName="경남";
				}else if(current =='jeonnam'){
					vCityName="전남";
				}else if(current =='gwangju'){
					vCityName="광주";
				}else if(current =='jeju'){
					vCityName="제주";
				}else if(current =='gangwon'){
					vCityName="강원";
				}else if(current =='gyeongbuk'){
					vCityName="경북";
				}else if(current =='busan'){
					vCityName="부산";
